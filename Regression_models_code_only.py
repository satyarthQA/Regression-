...
# Steps>> 
# 
# 1.3(a)Extracted 'temp' column  as feature variable and Y_multiple as target variable to perform operations
# 
# 
# 1.3(b)Created a model of polynomial degree 2 and train the model.Here we predicted coefficients.
#         
# 
# 1.3(c)plotted the expected non-linear regression model graph.(In 2d and 3d(in 1.3(d)))
# 
